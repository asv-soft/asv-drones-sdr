...
public class LlzWorkMode : WorkModeBase<IAnalyzerIls, AsvSdrRecordDataLlzPayload>
{
    ...
    protected override void InternalFill(AsvSdrRecordDataLlzPayload payload, RecordId record, uint dataIndex,
        GpsRawIntPayload gnss, AttitudePayload attitude,
        GlobalPositionIntPayload position)
    {
        payload.DataIndex = dataIndex;
        MavlinkTypesHelper.SetString(payload.RecordName, record.Name);
        // GNSS
